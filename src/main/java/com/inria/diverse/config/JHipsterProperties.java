...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "diverseSchol@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "diverseSchol API";

        private String description = "diverseSchol API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "diverseSchol";
